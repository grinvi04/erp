...
class StockServiceTest {
  ...
  void findByItem_existingItem_returnsPage() {
    ...
    given(stockRepository.findByItem_Id(eq(1L), any()))
  ...
  void findByItem_itemNotFound_throwsItemNotFound() {
    ...
    ErpException ex =
        assertThrows(ErpException.class, () -> stockService.findByItem(99L, PageRequest.of(0, 10)));
  ...
  void findByWarehouse_existingWarehouse_returnsPage() {
    ...
    given(stockRepository.findByWarehouseId(eq(1L), any()))
        .willReturn(new PageImpl<>(List.of(stock), pageable, 1));

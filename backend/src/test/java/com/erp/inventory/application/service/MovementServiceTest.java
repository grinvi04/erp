...
class MovementServiceTest {
  ...
  private Movement buildAdjustmentMovement() {
    return Movement.of(
        "MOV-20260624-44444", MovementType.ADJUSTMENT, LocalDate.of(2026, 6, 24), null, null, "조정");
  }
  ...
  private Movement buildDraftMovement() {
    return Movement.of(
        "MOV-20260624-11111", MovementType.RECEIPT, LocalDate.of(2026, 6, 24), null, null, "입고");
  }
  ...
  void create_receiptMovement_savesMovementAndLines() {
    ...
    MovementLine line =
        MovementLine.of(movement, 1, item, null, loc, null, null, BigDecimal.TEN, BigDecimal.ONE);
    ...
    MovementCreateRequest req =
        new MovementCreateRequest(
            ...
            "입고",
            List.of(
                new MovementLineRequest(1L, null, 2L, null, null, BigDecimal.TEN, BigDecimal.ONE)));
  ...
  void confirm_receiptMovement_createsNewStock() {
    ...
    Movement movement = buildDraftMovement();
    MovementLine line =
        MovementLine.of(movement, 1, item, null, toLoc, null, null, BigDecimal.TEN, BigDecimal.ONE);
  ...
  void confirm_issueMovement_decreasesExistingStock() {
    ...
    Movement movement =
        Movement.of(
            "MOV-20260624-22222", MovementType.ISSUE, LocalDate.of(2026, 6, 24), null, null, "출고");
    MovementLine line =
        MovementLine.of(
            movement, 1, item, fromLoc, null, null, null, BigDecimal.TEN, BigDecimal.ONE);
  ...
  void confirm_insufficientStock_throwsInsufficientStock() {
    ...
    Movement movement =
        Movement.of(
            "MOV-20260624-33333", MovementType.ISSUE, LocalDate.of(2026, 6, 24), null, null, "출고");
    MovementLine line =
        MovementLine.of(
            movement, 1, item, fromLoc, null, null, null, new BigDecimal("50"), BigDecimal.ONE);
            ...
            new java.util.ArrayList<>(
                List.of(
                    com.erp.common.workflow.ApprovalStep.of(
                        1, "재고 조정 이동 승인", "@role:inventory:movement:approve"))));
  ...
  void approve_pendingAdjustment_transitionsToConfirmedAndAppliesStock() {
    ...
    verify(permissionChecker)
        .require(com.erp.common.security.Permission.INVENTORY_MOVEMENT_APPROVE);

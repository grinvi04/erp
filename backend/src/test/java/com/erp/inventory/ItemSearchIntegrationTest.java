...
class ItemSearchIntegrationTest extends AbstractIntegrationTest {
  ...
  void setUp() {
    ...
    ItemCategory electronics =
        itemCategoryRepository.save(ItemCategory.of("CAT-ELEC", "Electronics", null));
    ItemCategory tools = itemCategoryRepository.save(ItemCategory.of("CAT-TOOL", "Tools", null));
  ...
  void keyword_matchesBySkuAndName_caseInsensitive() {
    ...
    assertThat(searchSkus("widget", null)).containsExactlyInAnyOrder("WIDGET-1", "HAMMER-3");
  }

...
class ContractControllerTest {
    ...
    void findByEmployee_returnsOkWithList() throws Exception {
        ContractResponse response = new ContractResponse(
            1L, 1L, ContractType.REGULAR, LocalDate.of(2020, 3, 1), null,
            BigDecimal.valueOf(50000000), 1L, "Engineer", null, null, null);
        given(contractService.findByEmployee(1L)).willReturn(List.of(response));

        mockMvc.perform(get("/api/hr/employees/1/contracts"))
    ...
    void findByEmployee_employeeNotFound_returns404() throws Exception {
        ...
        mockMvc.perform(get("/api/hr/employees/99/contracts"))
    ...
    void create_validRequest_returns201() throws Exception {
        ContractResponse response = new ContractResponse(
            1L, 1L, ContractType.REGULAR, LocalDate.of(2024, 1, 1), null,
            BigDecimal.valueOf(50000000), 1L, "Engineer", null, null, null);
        ...
        mockMvc.perform(post("/api/hr/employees/1/contracts")

...
class VendorSearchIntegrationTest extends AbstractIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        vendorRepository.save(Vendor.of("V-ACME", "Acme Corporation", "111-11-11111",
                null, null, null, 30));
        vendorRepository.save(Vendor.of("V-GLOBEX", "Globex Trading", "222-22-22222",
                null, null, null, 30));
        Vendor inactive = Vendor.of("V-OLDACME", "Old Acme Supplier", "333-33-33333",
                null, null, null, 30);
        inactive.deactivate();

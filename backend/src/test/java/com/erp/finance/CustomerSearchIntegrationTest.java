...
class CustomerSearchIntegrationTest extends AbstractIntegrationTest {
  ...
  void setUp() {
    customerRepository.save(
        Customer.of("C-ACME", "Acme Corporation", "111-11-11111", null, null, null, 30));
    customerRepository.save(
        Customer.of("C-GLOBEX", "Globex Trading", "222-22-22222", null, null, null, 30));
    Customer inactive =
        Customer.of("C-OLDACME", "Old Acme Buyer", "333-33-33333", null, null, null, 30);
    inactive.deactivate();

...
class ApInvoiceServiceTest {
  ...
  void create_foreignCurrencyWithRate_storesBaseSnapshot() {
    ...
    given(currencyConverter.tryConvert(any(), any(), any()))
        .willReturn(
            Optional.of(
                new Conversion(new BigDecimal("130000.00"), new BigDecimal("1300.00000000"))));
        ...
        assertThrows(
            ...
            () ->
                apInvoiceService.pay(
                    1L, new ApInvoicePayRequest(new BigDecimal("200000"), null, null)));
  ...
  void pay_bySelfCreator_throwsPaymentSelfForbidden() {
    ...
    ErpException ex =
        assertThrows(
            ...
            () ->
                apInvoiceService.pay(
                    1L, new ApInvoicePayRequest(new BigDecimal("100000"), null, null)));

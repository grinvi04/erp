...
class FxGainLossTest {
    ...
    void paymentRateHigherThanInvoiceRate_cashExceedsControl() {
        ...
        FxGainLoss fx = FxGainLoss.of(new BigDecimal("100"), new BigDecimal("1300"), new BigDecimal("1350"));
    ...
    void paymentRateLowerThanInvoiceRate_controlExceedsCash() {
        ...
        FxGainLoss fx = FxGainLoss.of(new BigDecimal("100"), new BigDecimal("1300"), new BigDecimal("1250"));
    ...
    void sameRate_noDifference() {
        FxGainLoss fx = FxGainLoss.of(new BigDecimal("100"), new BigDecimal("1300"), new BigDecimal("1300"));
    ...
    void partialPayment_proportionalToPaidAmount() {
        ...
        FxGainLoss fx = FxGainLoss.of(new BigDecimal("40"), new BigDecimal("1300"), new BigDecimal("1350"));
    ...
    void amounts_roundedToScale2_andDifferenceBalances() {
        ...
        FxGainLoss fx = FxGainLoss.of(new BigDecimal("33.33"), new BigDecimal("1300.12345"),
            new BigDecimal("1351.98765"));

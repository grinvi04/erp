...
/**
 * AC-1,7: V0007 백필 마이그레이션이 finance:write 보유 역할에 finance:setting:write를 멱등하게 부여하는지
...
class FinanceSettingWriteBackfillIntegrationTest extends AbstractIntegrationTest {
    ...
    private String migrationSql() throws Exception {
        return StreamUtils.copyToString(
                new ClassPathResource("db/migration/V0007__finance_setting_write_backfill.sql").getInputStream(),
    ...
    void backfill_grantsSettingWriteToFinanceWriteRoles_idempotently() throws Exception {
        Long roleId = jdbcTemplate.queryForObject(
                ...
                Long.class, TEST_TENANT_ID, "FIN_WRITER_SET_BF", "재무작성자");
        jdbcTemplate.update(

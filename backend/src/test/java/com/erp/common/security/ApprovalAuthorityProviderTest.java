...
class ApprovalAuthorityProviderTest {
  ...
  @InjectMocks private ApprovalAuthorityProvider provider;
  ...
  void getApprovalLimit_fromProfile() {
    currentUser();
    given(authorizationResolver.accessProfile(1L, "u"))
        .willReturn(
            Optional.of(
  ...
  void getApprovalLimit_nullLimitOnProfile_zero() {
    currentUser();
    given(authorizationResolver.accessProfile(1L, "u"))
        .willReturn(Optional.of(UserAccessProfile.of(1L, "u", DataScope.ALL, null, null)));

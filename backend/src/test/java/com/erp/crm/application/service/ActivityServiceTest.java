...
class ActivityServiceTest {
  ...
  private Activity buildActivity() {
    return Activity.of(ActivityType.CALL, "고객 통화", null, null, null, "user-001", null, "1차 컨택");
  }
  ...
  void create_validRequest_savesAsOpenWithCurrentUserAsOwner() {
    ...
    ActivityCreateRequest req =
        new ActivityCreateRequest(ActivityType.CALL, "고객 통화", null, null, null, null, "1차 컨택");

...
class ContactServiceTest {
    ...
    private Account buildAccount() {
        Account account = Account.of("ACC-001", "테스트고객사", null, null, null, null, null,
    ...
    private Contact buildContact(Account account, boolean isPrimary, long version) {
        Contact contact = Contact.of(account, "홍", "길동", "팀장", "구매팀",
                "hong@example.com", "02-000-0000", "010-0000-0000", isPrimary);
    ...
    void create_nonPrimary_savesAndReturns() {
        ...
        ContactCreateRequest req = new ContactCreateRequest(1L, "홍", "길동", "팀장", "구매팀",
                "hong@example.com", "02-000-0000", "010-0000-0000", false);
    ...
    void create_primaryWhenNoneExists_savesAndReturns() {
        ...
        ContactCreateRequest req = new ContactCreateRequest(1L, "홍", "길동", "팀장", "구매팀",
                "hong@example.com", "02-000-0000", "010-0000-0000", true);
    ...
    void create_primaryWhenAlreadyExists_throwsContactPrimaryDuplicate() {
        ...
        ContactCreateRequest req = new ContactCreateRequest(1L, "홍", "길동", null, null,
                null, null, null, true);
    ...
    void update_matchingVersion_updatesFields() {
        ...
        ContactUpdateRequest req = new ContactUpdateRequest("김", "철수", "부장", "영업팀",
                "kim@example.com", "02-111-1111", "010-1111-1111", false, 0L);
    ...
    void update_staleVersion_throwsOptimisticLock() {
        ...
        ContactUpdateRequest req = new ContactUpdateRequest("김", "철수", null, null,
                null, null, null, false, 1L);

        assertThrows(ObjectOptimisticLockingFailureException.class,
                () -> contactService.update(1L, req));
    }

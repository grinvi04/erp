...
class OpportunityServiceTest {
    ...
    void create_foreignCurrencyWithRate_storesBaseSnapshot() {
        ...
        opportunityService.create(new OpportunityCreateRequest(1L, "USD 딜", 1L,
                new BigDecimal("1000"), "USD", LocalDate.of(2026, 12, 31), 20, "REFERRAL", null));
    ...
    void create_noRate_leavesBaseSnapshotNull() {
        ...
        opportunityService.create(new OpportunityCreateRequest(1L, "JPY 딜", 1L,
                new BigDecimal("5000"), "JPY", LocalDate.of(2026, 12, 31), 20, "REFERRAL", null));
    ...
    void update_doesNotRecalculateBaseSnapshot() {
        ...
        Opportunity opp = Opportunity.of(buildAccount(), "USD 딜", buildStage(),
                new BigDecimal("1000"), "USD", LocalDate.of(2026, 12, 31), 20, "owner", null, null);
        opp.applyBaseSnapshot(new BigDecimal("1300000.00"), new BigDecimal("1300.00000000"));

        opp.update("USD 딜 수정", buildStage(), new BigDecimal("2000"), "USD",
                LocalDate.of(2026, 12, 31), 30, "owner", null, null);

...
public class FiscalYear extends BaseEntity {
    ...
    @SequenceGenerator(name = "fiscal_year_seq", sequenceName = "finance.fiscal_year_id_seq", allocationSize = 10)
    private Long id;
    ...
    public boolean isOpen() { return status == FiscalYearStatus.OPEN; }

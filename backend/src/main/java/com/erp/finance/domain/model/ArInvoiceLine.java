...
public class ArInvoiceLine extends BaseEntity {
  ...
  @SequenceGenerator(
      name = "ar_invoice_line_seq",
      sequenceName = "finance.ar_invoice_line_id_seq",
      allocationSize = 50)
  private Long id;
  ...
  static ArInvoiceLine of(
      ArInvoice arInvoice, int lineNo, Account account, BigDecimal amount, String description) {

...
public class JournalLine {
    ...
    @SequenceGenerator(name = "journal_line_seq", sequenceName = "finance.journal_line_id_seq", allocationSize = 200)
    private Long id;
    ...
    public static JournalLine of(JournalEntry entry, int lineNo, Account account,

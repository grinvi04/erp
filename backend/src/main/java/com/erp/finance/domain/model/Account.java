...
public class Account extends BaseEntity {
    ...
    @SequenceGenerator(name = "account_seq", sequenceName = "finance.account_id_seq", allocationSize = 50)
    private Long id;
    ...
    public static Account of(String code, String name, AccountType accountType,
                              NormalBalance normalBalance, Account parent, boolean isSummary) {

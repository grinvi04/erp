...
/**
 * 환율 — from_currency 1단위를 to_currency로 환산하는 비율(발효일 기준).
 * 조회는 effectiveDate ≤ 조회일 중 최신을 사용한다. 수동 등록·외부 provider 수집 양쪽으로 채워진다.
 */
@Entity
...
public class ExchangeRate extends BaseEntity {
    ...
    @SequenceGenerator(name = "exchange_rate_seq",
        sequenceName = "finance.exchange_rate_id_seq", allocationSize = 50)
    private Long id;
    ...
    public static ExchangeRate of(String fromCurrency, String toCurrency, LocalDate effectiveDate, BigDecimal rate) {

...
public class FiscalPeriod extends BaseEntity {
  ...
  @SequenceGenerator(
      name = "fiscal_period_seq",
      sequenceName = "finance.fiscal_period_id_seq",
      allocationSize = 50)
  private Long id;
  ...
  public static FiscalPeriod of(
      FiscalYear fiscalYear, int periodNumber, LocalDate startDate, LocalDate endDate) {

...
/**
 * 재무상태표 — 자산·부채·자본 계정의 연말 기준 누적 잔액 + 유형별 합계 + 당기순이익(자본 가산분) + 균형 여부. 균형식: 자산합 == 부채합 + 자본합 + 당기순이익
 * (±0.01).
 *
...
public record BalanceSheetResponse(
  ...
  public record BalanceSheetLine(String accountCode, String accountName, BigDecimal amount) {}
}

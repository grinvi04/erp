...
/**
 * GL 전표 전기 결재를 통합 결재함에 기여한다. 전결권(finance:gl:approve) 보유자에게 자기 전결 한도 내·본인 작성 아닌 대기(PENDING_APPROVAL)
 * 전표를 보여준다 — {@link JournalEntryService#approve}의 결재 권한 기준과 동일하게 산출한다.
 */
@Component

...
/**
 * 결재 단계. BaseEntity를 상속하지 않아 @TenantId·소프트삭제 필터가 없다 — 반드시 부모(ApprovalRequest, 테넌트 필터됨)를 통해서만 조회할 것.
...
public class ApprovalStep {
  ...
  @SequenceGenerator(
      name = "approval_step_seq",
      sequenceName = "common.approval_step_id_seq",
      allocationSize = 50)
  private Long id;

...
public enum ErrorCode {
  ...
  DEPRECIATION_ACCOUNT_NOT_CONFIGURED(
      HttpStatus.CONFLICT, "F044", "감가상각비·감가상각누계액 계정이 설정되지 않아 상각을 처리할 수 없습니다"),
  ...
  IMPAIRMENT_REVERSAL_SAME_PERIOD_AS_IMPAIRMENT(
      HttpStatus.CONFLICT, "F053", "같은 회계기간에 인식한 손상은 환입할 수 없습니다(이전 기간 손상만 환입 가능)"),

...
/**
 * 기능 권한 검사 — application 유스케이스 진입점에서 호출한다(auth-standards: 검사 위치는
 * 유스케이스 진입점, 컨트롤러 어노테이션은 보조). 현재 인증 사용자의 authority(권한 코드)에
 * 요구 권한이 없으면 {@link ErrorCode#FORBIDDEN}을 던진다.
 */
@Component

...
public class Location extends BaseEntity {
    ...
    @SequenceGenerator(name = "location_seq", sequenceName = "inventory.location_id_seq", allocationSize = 100)
    private Long id;
    ...
    public static Location of(Warehouse warehouse, String code, String name,
            Location parent, LocationType locationType) {

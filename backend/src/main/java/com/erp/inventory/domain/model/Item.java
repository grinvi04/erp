...
public class Item extends BaseEntity {
    ...
    public static Item of(String sku, String name, String description,
            ItemCategory category, UnitOfMeasure uom, CostMethod costMethod,
            BigDecimal standardCost, BigDecimal reorderPoint, BigDecimal reorderQty,
            BigDecimal minStock, BigDecimal maxStock,
            boolean lotTracked, boolean serialTracked) {
        Item item = new Item();
    ...
    public void update(String name, String description, ItemCategory category,
            UnitOfMeasure uom, CostMethod costMethod, BigDecimal standardCost,

...
public class MovementLine extends BaseEntity {
    ...
    @SequenceGenerator(name = "movement_line_seq", sequenceName = "inventory.movement_line_id_seq", allocationSize = 500)
    private Long id;
    ...
    public static MovementLine of(Movement movement, Integer lineNo, Item item,
            Location fromLocation, Location toLocation,
            String lotNo, String serialNo, BigDecimal qty, BigDecimal unitCost) {

...
/**
 * 재고 조정(ADJUSTMENT) 이동 확정 결재를 통합 결재함에 기여한다. 결재권(inventory:movement:approve)
 * 보유자에게 본인 작성 아닌 대기(PENDING_APPROVAL) 조정 이동을 보여준다 —
 * {@link MovementService#approve}의 결재 권한 기준과 동일하게 산출한다. 재고는 금액 전결한도 미적용.
 */
@Component

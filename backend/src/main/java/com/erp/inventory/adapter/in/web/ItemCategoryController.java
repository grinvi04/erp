...
public class ItemCategoryController {
  ...
  public ResponseEntity<ApiResponse<List<ItemCategoryResponse>>> findChildren(
  ...
  public ResponseEntity<ApiResponse<ItemCategoryResponse>> create(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(ApiResponse.ok(itemCategoryService.create(req)));
  }

  @PutMapping("/{id}")
  public ResponseEntity<ApiResponse<ItemCategoryResponse>> update(
      @PathVariable Long id, @Valid @RequestBody ItemCategoryUpdateRequest req) {

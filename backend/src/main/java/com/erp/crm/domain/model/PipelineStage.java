...
public class PipelineStage extends BaseEntity {
  ...
  @SequenceGenerator(
      name = "pipeline_stage_seq",
      sequenceName = "crm.pipeline_stage_id_seq",
      allocationSize = 20)
  private Long id;
  ...
  public static PipelineStage of(
      String name, int stageOrder, int probability, boolean isClosedWon, boolean isClosedLost) {

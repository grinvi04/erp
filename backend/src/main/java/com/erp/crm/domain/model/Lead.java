...
public class Lead extends BaseEntity {
    ...
    public static Lead of(String lastName, String firstName, String company, String title,
                          String email, String phone, String source, String ownerId, String note) {
        Lead l = new Lead();
        l.lastName = lastName;
    ...
    public void update(String lastName, String firstName, String company, String title,
                       String email, String phone, String source, String ownerId, String note) {
    ...
    public void qualify() { this.status = LeadStatus.QUALIFIED; }

    public void contact() { this.status = LeadStatus.CONTACTED; }

    public void disqualify() { this.status = LeadStatus.DISQUALIFIED; }
    ...
    public boolean isConverted() { return this.status == LeadStatus.CONVERTED; }
    ...
    public Account getConvertedAccount() { return convertedAccount; }
    public Long getConvertedOpportunityId() { return convertedOpportunityId; }

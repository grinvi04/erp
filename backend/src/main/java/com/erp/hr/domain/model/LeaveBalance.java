...
public class LeaveBalance extends BaseEntity {
    ...
    @SequenceGenerator(name = "leave_balance_seq", sequenceName = "hr.leave_balance_id_seq", allocationSize = 50)
    private Long id;
    ...
    public BigDecimal getCarryOverDays() { return carryOverDays; }
}

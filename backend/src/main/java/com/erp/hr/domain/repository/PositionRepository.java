...
public interface PositionRepository extends JpaRepository<Position, Long> {
    ...
    @Query("SELECT p.id AS positionId, p.name AS positionName, COUNT(e.id) AS count "
    ...
    List<PositionHeadcountRow> headcountByPosition(@Param("unscoped") boolean unscoped,

...
/**
 * 직원 마스터 — 인적사항 + 재직 정보.
 * 급여는 기록 목적(Finance 연산 없음).
 * 조직 구조: Employee → Department → Department(상위) → ... → Company(최상위 Department)
 */
@Entity
...
public class Employee extends BaseEntity {
    ...
    @SequenceGenerator(name = "employee_seq", sequenceName = "hr.employee_id_seq", allocationSize = 50)
    private Long id;
    ...
    public static Employee create(String employeeNo, PersonalInfo personalInfo,
                                   Department department, Position position,
                                   JobGrade jobGrade, LocalDate hireDate,
                                   EmploymentType employmentType, String workEmail,

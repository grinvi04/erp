...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
    ...
    @Query("SELECT d.id AS departmentId, d.name AS departmentName, COUNT(e.id) AS count "
    ...
    List<DepartmentHeadcountRow> headcountByDepartment(@Param("unscoped") boolean unscoped,

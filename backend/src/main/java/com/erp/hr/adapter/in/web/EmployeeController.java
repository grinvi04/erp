...
public class EmployeeController {
  ...
  public ResponseEntity<ApiResponse<EmployeeResponse>> transfer(
      @PathVariable Long id, @Valid @RequestBody EmployeeTransferRequest request) {
  ...
  public ResponseEntity<ApiResponse<EmployeeResponse>> promote(
      @PathVariable Long id, @Valid @RequestBody EmployeePromoteRequest request) {
  ...
  public ResponseEntity<ApiResponse<EmployeeResponse>> terminate(
      @PathVariable Long id, @Valid @RequestBody EmployeeTerminateRequest request) {

...
export E2E_COMMERCIAL_RESTRICTED_USERNAME=${E2E_COMMERCIAL_RESTRICTED_USERNAME:-uat-commercial-restricted}
...
export E2E_COMMERCIAL_RESTRICTED_PASSWORD=${E2E_COMMERCIAL_RESTRICTED_PASSWORD:-$(openssl rand -base64 24)}
